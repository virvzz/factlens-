...
- Требует оплаты, платных услуг или ПО? — **Да** (нужны API-ключи сторонних
  AI-сервисов; есть и бесплатные варианты — Groq, локальные серверы).

## Categories (до 3)

- **Инструменты поиска** (Search Tools)
- **Приватность и защита** (Privacy & Security)
- **Ленты новостей и блоги** (News & Blogging)

## Support / Homepage

- Homepage: `https://github.com/virvzz/factlens-`
- Сайт поддержки: `https://github.com/virvzz/factlens-/issues`
...
7. Code is plain unminified JavaScript, no bundler, no remote code. Source:
   https://github.com/virvzz/factlens- (tests: npm test, lint: web-ext lint).
...
The uploaded ZIP is produced by "web-ext build" from unmodified sources — no
transpilation, bundling or minification. Source code submission is therefore
not applicable; full sources: https://github.com/virvzz/factlens-
```
